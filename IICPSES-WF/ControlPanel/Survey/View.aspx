...
<asp:Content ID="Content3" ContentPlaceHolderID="cphMainContent" runat="server">
    <div class="row">
        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header">View Survey Profile - <strong><asp:Label runat="server" ID="lblSurveySecret" /></strong></div>
                <div class="card-block">
                    ...
                    <table class="table">
                        <tr>
                            <td>ID</td>
                            <td><asp:Label ID="lblID" runat="server" Font-Bold="true" /></td>
                        </tr>
                        <tr>
                            <td>School Code</td>
                            <td><asp:Label ID="lblSchoolCode" runat="server" Font-Bold="true" /></td>
                        </tr>
                        <tr>
                            <td>School Name</td>
                            <td><asp:Label ID="lblSchoolName" runat="server" Font-Bold="true" /></td>
                        </tr>
                        <tr>
                            <td>Program Code</td>
                            <td><asp:Label ID="lblProgramCode" runat="server" Font-Bold="true" /></td>
                        </tr>
                        <tr>
                            <td>Program Name</td>
                            <td><asp:Label ID="lblProgramName" runat="server" Font-Bold="true" /></td>
                        </tr>
                        <tr>
                            <td>Subject Code</td>
                            <td><asp:Label ID="lblSubjectCode" runat="server" Font-Bold="true" /></td>
                        </tr>
                        <tr>
                            <td>Subject Name</td>
                            <td><asp:Label ID="lblSubjectName" runat="server" Font-Bold="true" /></td>
                        </tr>
                        <tr>
                            <td>Lecturer Name</td>
                            <td><asp:Label ID="lblLecturerName" runat="server" Font-Bold="true" /></td>
                        </tr>
                        <tr>
                            <td>Secret Code Text</td>
                            <td><asp:Label ID="lblSecretCodeText" runat="server" Font-Bold="true" /></td>
                        </tr>
                        <tr>
                            <td>Created Timestamp</td>
                            <td><asp:Label ID="lblCreatedDate" runat="server" Font-Bold="true" /></td>
                        </tr>
                    </table>
